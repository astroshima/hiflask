...
@app.route('/')             # dekorator funkcije koji mapira URL putanju na serveru, na akciju kontrolera (funkciju); kada Flaskov veb server dobije zahtev sa URL putanjom '/', pozovi funkciju hello() 
